                                ...
                                <div class="produk-input-row">
                                    <select name="produk_id[]" class="form-control @error('produk_id') is-invalid @enderror">
                                        ...
                                        @foreach ($produk as $item)
                                            <option value="{{ $item->id }}">{{ $item->nama_produk }} {{ $item->merk }} harga Rp {{ $item->harga_jual_rim }}/rim Rp {{ $item->harga_jual_ecer }}/lembar</option>
                                        @endforeach
                                    </select>
                                    <div>
                                    ...
                                    <div>
                                      <label for="exampleInputEmail1" class="form-label">Jumlah Lembar</label>
                                      <input name="jumlah_ecer[]" type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="0">
                                    </div>
